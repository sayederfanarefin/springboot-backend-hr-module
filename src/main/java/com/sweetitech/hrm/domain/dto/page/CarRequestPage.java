...
public class CarRequestPage implements Page {

    private List<CarRequestResponseDTO> content;
    ...
    public CarRequestPage(List<CarRequestResponseDTO> content, Page page) {
    ...
    public void setContent(List<CarRequestResponseDTO> content) {
        this.content = content;
    }
