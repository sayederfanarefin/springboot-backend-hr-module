...
public class CarSchedulePage implements Page {

    private List<CarScheduleResponseDTO> content;
    ...
    public CarSchedulePage(List<CarScheduleResponseDTO> content, Page page) {
    ...
    public void setContent(List<CarScheduleResponseDTO> content) {
        this.content = content;
    }
