...
public class MobileLogsPage implements Page {

    private List<MobileLogsResponseDTO> content;
    ...
    public MobileLogsPage(List<MobileLogsResponseDTO> content, Page page) {
    ...
    public void setContent(List<MobileLogsResponseDTO> content) {
        this.content = content;
    }
