...
public class TenderResponseDTO {
    ...
    private boolean copyOfTenderSecurityInFile;
    ...
    private UserSmallResponseDTO createdByUser;
    ...
    public UserSmallResponseDTO getCreatedByUser() {
        return createdByUser;
    }

    public void setCreatedByUser(UserSmallResponseDTO createdByUser) {
